...
TASK_DEFINITIONS: dict[tuple[str, int], TaskProgressDefinition] = {
    ...
    ("libero_10", 2): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=2,
        ...
        predicates=(
            _goal(
                ...
                "turnon",
                "flat_stove_1",
                description="independently measurable stove-state commitment",
            ),
            _goal(
                "moka_pot_on_stove",
                "on",
                ...
                description="independently measurable placement commitment",
            ),
            _reachable("moka_pot_reachable", "moka_pot_1"),
            _final(),
        ),
        target_joints=("moka_pot_1_joint0",),
        receptacle_joints=(),
        tool_joints=("moka_pot_1_joint0",),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
    ("libero_10", 3): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=3,
        ...
        predicates=(
            _goal(
                ...
                description="independently measurable articulated-state commitment",
            ),
            _goal(
            ...
            _reachable("black_bowl_reachable", "akita_black_bowl_1"),
            _final(),
        ),
        target_joints=("akita_black_bowl_1_joint0",),
        receptacle_joints=(),
        tool_joints=("akita_black_bowl_1_joint0",),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
    ...
    ("libero_10", 5): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=5,
        ...
        predicates=(
            _goal(
                "book_in_back_compartment",
                "in",
                "black_book_1",
                "desk_caddy_1_back_contain_region",
                description="source BDDL placement commitment",
            ),
            _reachable("book_reachable", "black_book_1"),
            _reachable("caddy_reachable", "desk_caddy_1"),
            _final(),
        ),
        target_joints=("black_book_1_joint0",),
        receptacle_joints=(),
        tool_joints=("black_book_1_joint0",),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
    ("libero_10", 6): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=6,
        task_name=(
        ...
        predicates=(
            ...
            _goal(
                "pudding_right_of_plate",
                "on",
                "chocolate_pudding_1",
                "living_room_table_plate_right_region",
                description="second independently measurable placement commitment",
            ),
            _reachable("plate_reachable", "plate_1"),
            _final(),
        ),
        target_joints=("porcelain_mug_1_joint0", "chocolate_pudding_1_joint0"),
        receptacle_joints=("plate_1_joint0",),
        tool_joints=("porcelain_mug_1_joint0", "chocolate_pudding_1_joint0"),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
    ("libero_10", 7): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=7,
        ...
        target_joints=("alphabet_soup_1_joint0", "cream_cheese_1_joint0"),
        receptacle_joints=("basket_1_joint0",),
        tool_joints=("alphabet_soup_1_joint0", "cream_cheese_1_joint0"),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
    ...
    ("libero_10", 9): TaskProgressDefinition(
        task_suite="libero_10",
        task_id=9,
        ...
        predicates=(
            ...
            _reachable("yellow_white_mug_reachable", "white_yellow_mug_1"),
            _final(),
        ),
        target_joints=("white_yellow_mug_1_joint0",),
        receptacle_joints=(),
        tool_joints=("white_yellow_mug_1_joint0",),
        workspace_xy_bounds=((-0.35, 0.35), (-0.36, 0.36)),
    ),
}
