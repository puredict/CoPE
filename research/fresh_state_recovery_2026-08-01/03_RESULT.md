...
The strict rejection follows the frozen 10/10 prefix-integrity requirement.
The state-5 failure is method-independent, so the nine event-qualified pairs
remain useful conditional mechanism evidence, but they cannot repair the
assigned-denominator decision. States 5–14 may not be reused as fresh data for
a modified rule.
