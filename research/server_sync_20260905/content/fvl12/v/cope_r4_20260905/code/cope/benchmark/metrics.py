...
class EpisodeMetrics:
    ...
    # --- failure layers (see cope/benchmark/failure_layers.py)
    all_required_events_delivered: Optional[bool] = None
    failure_layer: str = ""
    adaptation_failure: Optional[bool] = None
    controller_failure: Optional[bool] = None
    infrastructure_failure: Optional[bool] = None
    # --- audit
