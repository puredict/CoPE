"""Forwarding wrapper -> code/scripts/run_omni_smoke_test.py (single source of truth).
...
TARGET = Path(__file__).resolve().parents[1] / "code" / "scripts" / "run_omni_smoke_test.py"
