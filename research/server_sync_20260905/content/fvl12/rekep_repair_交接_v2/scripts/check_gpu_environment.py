"""Forwarding wrapper -> code/scripts/check_gpu_environment.py (single source of truth).
...
TARGET = Path(__file__).resolve().parents[1] / "code" / "scripts" / "check_gpu_environment.py"
