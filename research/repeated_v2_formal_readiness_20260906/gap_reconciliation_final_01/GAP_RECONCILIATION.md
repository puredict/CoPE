...
Observed current diagnostics: 752. Closed by attached evidence: 42.
Open baseline rows: 752. Unexplained disappearances retained OPEN: 0.
Documented wording migrations retained OPEN: 10. Explicit new diagnostics: 0.
Baseline root packages: 127 → 120 still open.
Baseline artifact units: 357 → 350 still open.
